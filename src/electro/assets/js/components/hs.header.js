...
(function ($) {
  ...
  $.HSCore.components.HSHeader = {
    ...
    init: function (element) {
      ...
      this.element.data(
        "HSHeader",
        new HSHeader(this.element, this.config, this.observers)
      );
      ...
      $(window)
        .on("scroll.uHeader", function (e) {
          if (
            $(window).scrollTop() <
              $(element).data("header-fix-moment") - 100 &&
            $(element).data("effect-compensation") === true
          ) {
            $(element)
              .css({
    ...
    fixMediaDifference: function (element) {
      if (
        !element ||
        !element.length ||
        !element.filter('[class*="u-header--side"]').length
      )
        return;
      ...
      if (
        element.hasClass("u-header--side-left-xl") ||
        element.hasClass("u-header--side-right-xl")
      ) {
        ...
        element.hasClass("u-header--side-left-lg") ||
        element.hasClass("u-header--side-right-lg")
      ) {
        ...
        element.hasClass("u-header--side-left-md") ||
        element.hasClass("u-header--side-right-md")
      ) {
        ...
        element.hasClass("u-header--side-left-sm") ||
        element.hasClass("u-header--side-right-sm")
      ) {
  ...
  HSHeader.prototype.checkViewport = function () {
    ...
    if (
      $w.width() > this.config.breakpointsMap["sm"] &&
      ...
      if (
        ...
        $w.scrollTop() > this.element[0].dataset.headerFixMoment
      ) {
    ...
    if (
      $w.width() > this.config.breakpointsMap["md"] &&
    ...
    if (
      $w.width() > this.config.breakpointsMap["lg"] &&
    ...
    if (
      $w.width() > this.config.breakpointsMap["xl"] &&
  ...
  HSHeaderMomentShowHideObserver.prototype.init = function () {
    ...
    this.offset =
      ...
      this.element.data("header-fix-moment") !== 0
  ...
  HSHeaderShowHideObserver.prototype.init = function () {
    ...
    this.offset =
      isFinite(this.element.data("header-fix-moment")) &&
      this.element.data("header-fix-moment") > this.element.outerHeight()
        ? this.element.data("header-fix-moment")
  ...
  HSHeaderShowHideObserver.prototype.check = function () {
    ...
    if ($w.scrollTop() > this.element.outerHeight() && !this.capInserted) {
      ...
      $w.scrollTop() <= this.element.outerHeight() &&
      this.capInserted
    ) {
      this._removeCap();
    }
  ...
  HSHeaderFloatingObserver.prototype.changeState = function () {
    ...
    if (this.sections.length) {
      this.sections.each(function (i, el) {
        ...
        $section
          .addClass($section.data("header-fix-moment-classes"))
  ...
  HSHeaderFloatingObserver.prototype.toDefaultState = function () {
    ...
    if (this.sections.length) {
      this.sections.each(function (i, el) {
        ...
        $section
          .removeClass($section.data("header-fix-moment-classes"))
