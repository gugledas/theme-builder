...
(function (window, document, $) {
  ...
  Guestures.prototype.ontouchstart = function (e) {
    ...
    if (
      !(instance.current.opts.touch || instance.canPan()) ||
  ...
  Guestures.prototype.ontouchmove = function (e) {
    ...
    if (
      !(self.instance.current.opts.touch || self.instance.canPan()) ||
      !self.newPoints ||
    ...
    if (self.distance > 0) {
      if (
        !(self.$target.is(self.$stage) || self.$stage.find(self.$target).length)
      ) {
        return;
      }
    ...
    if (swiping === true) {
      if (Math.abs(self.distance) > 10) {
        ...
        if (
          ...
          self.instance.opts.touch.vertical
        ) {
          self.isSwiping = "y";
        } else if (
  ...
  $.extend(SlideShow.prototype, {
    ...
    start: function () {
      ...
      if (
        self.instance &&
        current &&
        (current.opts.loop || current.index < self.instance.group.length - 1)
      ) {
        self.isActive = true;
