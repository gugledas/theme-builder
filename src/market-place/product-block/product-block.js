...
document.querySelectorAll(".product-gallery").forEach(carousel => {
    ...
    buttons.forEach((button, i) => {
        button.addEventListener("click", () => {
            ...
            items.forEach(item => item.classList.remove("product-gallery__image_selected"))
            buttons.forEach(button => button.classList.remove("product-gallery__bullets_item_selected"))
